function  [X,F,ev,rcond1] = sldares(A,Q,R,B,L,flag)
%SLDARES  Solve DARE with Schur method.
%
%         Case I.
%           [X,F,EV,RCOND1] = SLDARES(A,Q,R,B,L,FLAG)  computes the
...
%         
%           [X,EV,RCOND1] = SLDARES(A,Q,R,B,L,FLAG)  does not compute
%         the feedback gain F.
%         
%           [X1,X2,EV,RCOND1] = SLDARES(A,Q,R,B,L,FLAG)  computes a
%                                               [ X1 ]
...
%         
%         Case II.
%           [X,EV,RCOND1] = SLDARES(A,Q,G,FLAG)  computes the symmetric
...
%         
%           [X1,X2,EV,RCOND1] = SLDARES(A,Q,G,FLAG)  computes a basis
%                                         [ X1 ]
...
%         Default: FLAG = [0,0,1].
%         
%         See also ARESOL, SLCAREGS, SLCARES, SLDAREGS, SLDAREGSV
%         
