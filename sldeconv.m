function c = sldeconv( a, b, meth, pad0 )
%SLDECONV Computes the deconvolution of two real signals of equal length
%         using either FFT or Hartley transform.
% 
%        C = SLDECONV(A,B)  computes the deconvolution of the signals A
...
%
%        C = SLDECONV(A,B,METH,PAD0)  has additional input arguments:
%
...
%        Default:  PAD0 = 0.
%
%        See also SLCONV, SLDFT, SLIDFT, SLHART
%
...
%
if ni < 2,
    error('Usage: C = SLDECONV(A,B,METH,PAD0)')
elseif ni == 2,
    meth = 0;
    pad0 = 0;
elseif ni == 3,
