% Script for testing the performance of SLICOT continuous-time 
...
disp('Comparison between sllyap and lyap')
disp('----------------------------------')
disp(' ')
...
disp('------------------------------------------------------------------------')
disp('    n  sllyap   lyap    sllyap        lyap        sllyap        lyap    ')
disp('------------------------------------------------------------------------')
...
disp('----------------------------------------------')
disp('    n  sllyap   lyap    sllyap        lyap    ')
disp('----------------------------------------------')
