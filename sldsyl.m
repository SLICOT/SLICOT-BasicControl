function [X] = sldsyl(A,B,C,flag,trans,schur)
%SLDSYL  Solve discrete-time Sylvester equations.
%
%        X = SLDSYL(A,B,C,FLAG,TRANS,SCHUR)  computes the unique
%        solution X of a discrete-time Sylvester equation
%
%             op(A)*X*op(B) + X = C,
%
%        where op(M) = M or M'.
...
%        Default: SCHUR = 1.
%
%        See also LINMEQ, SLLYAP, SLSTEI, SLSTLY, SLSTST, SLSYLV
%
...
%
%        V. Sima 18-04-2000.
%        Revised V. Sima 12-09-2000, 03-03-2009.
%
