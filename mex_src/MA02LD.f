      SUBROUTINE MA02LD( UPLO, M, N, I, J, ALPHA, BETA, A, LDA )
C
...
C
C     This is a wrapper to the LAPACK Library routine DLASET, used for
...
C
      CALL DLASET( UPLO, M, N, ALPHA, BETA, A(I,J), LDA )
C
      RETURN
C *** Last line of MA02LD ***
      END
