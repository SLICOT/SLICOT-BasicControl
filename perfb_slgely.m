...
disp('Performance of slgely (generalized continuous-time Lyapunov solver)')
disp('-------------------------------------------------------------------')
disp(' ')
...
% SLICOT calculations.
  ...
  res(l,3) = norm(A'*X*E + E'*X*A - C,'fro')/normXo;
