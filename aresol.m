% ARESOL.F - MEX-function for solving algebraic Riccati equations
%            using SLICOT routines SB02MD, SB02ND, SB02MT and SB02OD.
%
%     [X(,F),ev(,db),rcond1] = aresol(method,A,Q,R,B,L,flag)
%         [X,ev(,db),rcond1] = aresol(method,A,Q,G,flag)
%   [Z,scale,ev(,db),rcond1] = aresol(method,A,Q,R,B,L,flag)
%   [Z,scale,ev(,db),rcond1] = aresol(method,A,Q,G,flag)
%
%   method = 1:        [X,F,ev,rcond1] = aresol(1,A,Q,R,B,L,flag)
%                        [X,ev,rcond1] = aresol(1,A,Q,R,B,L,flag)
%                        [X,ev,rcond1] = aresol(1,A,Q,G,flag)
%                  [Z,scale,ev,rcond1] = aresol(1,A,Q,R,B,L,flag)
%                  [Z,scale,ev,rcond1] = aresol(1,A,Q,G,flag)
%   method = 2:     [X,F,ev,db,rcond1] = aresol(2,A,Q,R,B,L,flag)
%                     [X,ev,db,rcond1] = aresol(2,A,Q,R,B,L,flag)
%                     [X,ev,db,rcond1] = aresol(2,A,Q,G,flag)
%               [Z,scale,ev,db,rcond1] = aresol(2,A,Q,R,B,L,flag)
%               [Z,scale,ev,db,rcond1] = aresol(2,A,Q,G,flag)
%   method = 3:     [X,F,ev,db,rcond1] = aresol(3,A,Q,R,B,L,flag)
%                     [X,ev,db,rcond1] = aresol(3,A,Q,R,B,L,flag)
%               [Z,scale,ev,db,rcond1] = aresol(3,A,Q,R,B,L,flag)
%         
%   ARESOL solves the continuous-time algebraic Riccati equations
%                                      -1
...
%
%   See also SLCAREGS, SLCARES, SLDAREGS, SLDAREGSV, SLDARES

% RELEASE 2.0 of SLICOT Basic Systems and Control Toolbox.
% Based on SLICOT RELEASE 5.7, Copyright (c) 2002-2020 NICONET e.V.
%
% Contributor:
%   H. Xu, TU Chemnitz, FR Germany, Nov. 1998.
%
% Revisions:
